...
# 2
LABEL maintainer=alfredoiglesiassnchez@yahoo.es
...
# Variables de entorno para los plugins 
...
#Ejecucion para instalar los plugins
RUN cd /tmp/ \
...
#FROM egaillardon/jmeter:5.1.1-1.0.0RUN curl -L --silent ${JMETER_PLUGINS_DOWNLOAD_URL}/jmeter-plugins-cmn-jmeter/0.5/jmeter-plugins-cmn-jmeter-0.5.jar -o ${JMETER_PLUGINS_FOLDER}/jmeter-plugins-cmn-jmeter-0.5.jar
